        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.3fr_1fr]">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-slate-300 sm:text-lg">
              Designed for safer sewage treatment plants, Ex-Terminator automates hazardous cleaning
              tasks through intelligent locomotion, precision sludge breakdown, and high-efficiency
              extraction.
            </p>
          ...
          <div className="card-surface relative overflow-hidden">
            ...
            <h3 className="mt-3 text-2xl font-bold text-slate-100">Human Safety First</h3>
            <p className="mt-4 text-slate-300">
              Replace dangerous manual sludge cleaning with an industrial-grade autonomous platform
              that prioritizes worker health, treatment uptime, and operational consistency.
            </p>
            <div className="mt-6 grid grid-cols-2 gap-4 text-center">
              <div className="rounded-xl border border-cyan-400/25 bg-slate-950/60 p-4">
                ...
                <p className="mt-1 text-xs uppercase tracking-[0.16em] text-slate-400">Core Steps</p>
              </div>
              <div className="rounded-xl border border-cyan-400/25 bg-slate-950/60 p-4">
                <p className="text-2xl font-bold text-cyan-300">5</p>
                <p className="mt-1 text-xs uppercase tracking-[0.16em] text-slate-400">Main Modules</p>
              </div>
            </div>
          </div>
        </div>
