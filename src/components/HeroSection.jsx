        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.3fr_1fr]">
          <div>
            <p className="mb-4 inline-flex rounded-full border border-cyan-300/35 px-4 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-cyan-200">
              Cable-Suspended & Drone-Assist Sludge Removal System
            </p>
            <h1 className="heading-glow text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
              Ex-Terminator
            </h1>
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-slate-300 sm:text-lg">
              Ex-Terminator delivers a working above-water cleaning prototype for open sewage tanks today,
              while defining a scalable drone-assisted expansion path for closed tank environments tomorrow.
            </p>
            <div className="mt-5 flex flex-wrap gap-2 text-[11px] font-semibold uppercase tracking-[0.14em] text-cyan-100/90 sm:text-xs">
              ...
              <span className="rounded-full border border-cyan-300/30 bg-slate-900/70 px-3 py-1">
                Working Open-Tank Prototype
              </span>
              <span className="rounded-full border border-cyan-300/30 bg-slate-900/70 px-3 py-1">
                Scalable Future Concept
              </span>
            </div>
          ...
          <div className="card-surface relative overflow-hidden">
            ...
            <h3 className="mt-3 text-2xl font-bold text-slate-100">Built for Now, Ready for Next</h3>
            <p className="mt-4 text-slate-300">
              The current cable-suspended model is fully deployable for open tanks, and the architecture is
              deliberately designed to evolve toward drone-assisted operation in restricted facilities.
            </p>
            <div className="mt-6 grid grid-cols-2 gap-4 text-center">
              <div className="rounded-xl border border-cyan-400/25 bg-slate-950/60 p-4">
                ...
                <p className="mt-1 text-xs uppercase tracking-[0.16em] text-slate-400">System Variants</p>
              </div>
              <div className="rounded-xl border border-cyan-400/25 bg-slate-950/60 p-4">
                <p className="text-2xl font-bold text-cyan-300">1</p>
                <p className="mt-1 text-xs uppercase tracking-[0.16em] text-slate-400">Working Prototype</p>
              </div>
            </div>
          </div>
        </div>
